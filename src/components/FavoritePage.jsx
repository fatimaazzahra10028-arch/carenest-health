...
const FavoritePage = ({ onBack, onArticleClick }) => {
  ...
  const clearAllFavorites = () => {
    if (
      window.confirm(
        "Apakah Moms yakin ingin menghapus semua artikel simpanan?",
      )
    ) {
      setFavorites([]);
            ...
            {favorites.map((article, index) => (
              ...
              >
                ...
                <div className="flex-1 px-2">
                  ...
                  <h3
                    className="text-xl font-bold text-text-main line-clamp-2 mb-4 font-kids leading-snug group-hover:text-primary transition-colors cursor-pointer"
...
const EmptyState = ({ onBack }) => (
  ...
  >
    ...
    <h2 className="text-3xl font-kids text-text-main font-bold mb-4">
      Koleksi Masih Kosong
    </h2>
    <p className="text-text-muted mb-10 leading-relaxed font-medium">
      Moms belum menyimpan artikel apapun. Yuk, jelajahi ribuan tips menarik
      untuk si kecil!
    </p>

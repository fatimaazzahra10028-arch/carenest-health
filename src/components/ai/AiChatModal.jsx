          ...
          <AnimatePresence>
            {view === "chat" ? (
              ...
              <div className="p-4 text-center space-y-6">
                 ...
                 <div>
                    <h4 className="font-kids text-xl text-text-main">Konsultasi Langsung</h4>
                    <p className="text-xs text-text-muted mt-1">Lengkapi data singkat untuk dikirim ke Dokter Ahli</p>
                 </div>

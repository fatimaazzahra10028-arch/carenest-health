...
const HeroSection = ({
  ...
  return (
    <section className="pt-16 pb-12 px-6 text-center transition-colors duration-300">
      ...
      >
        {/* text-slate-800 diganti text-text-main */}
        ...
        {/* text-slate-500 diganti text-text-muted */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 max-w-2xl mx-auto mb-12">
          ...
          >
            <input
              ...
              /* bg-white/60 diganti bg-card/60 dan border-white/50 diganti border-border-soft */
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onStartAI}
            /* bg-white diganti bg-card dan text-primary tetap (karena primary sudah kita sesuaikan di CSS) */

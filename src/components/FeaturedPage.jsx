        ...
        {isConfirmOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-2xl font-kids font-bold text-slate-800 dark:text-slate-100 mb-2">
                Hapus Semua?
              </h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm mb-8 leading-relaxed">
                Semua artikel favorit Moms akan terhapus secara permanen dari
                koleksi ini.
              </p>
...
const EmptyState = ({ onBack }) => (
  ...
  >
    ...
    <h2 className="text-2xl font-kids text-slate-800 dark:text-white font-bold mb-3">
      Belum Ada Simpanan
    </h2>
    <p className="text-sm text-slate-500 dark:text-slate-400 mb-10 leading-relaxed">
      Kumpulkan tips kesehatan dan parenting yang Moms sukai di sini untuk
      dibaca nanti.
    </p>
    <button
      onClick={onBack}
